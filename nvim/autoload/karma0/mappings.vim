func! karma0#mappings#setup() abort
  ...
  nnoremap <silent> [search]af :call karma0#search#all_files()<CR>
  nnoremap <silent> [search]gf :call karma0#search#files_in_git()<CR>
  nnoremap <silent> [search]b  :call karma0#search#buffers()<CR>
  nnoremap <silent> [search]t  :call karma0#search#tags()<CR>
  nnoremap <silent> [search]h  :call karma0#search#history()<CR>
  nnoremap <silent> [search]w  :call karma0#search#windows()<CR>
